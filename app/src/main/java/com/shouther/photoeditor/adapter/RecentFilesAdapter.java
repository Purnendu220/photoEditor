...
import com.shouther.photoeditor.viewholder.RecentFilesViewHolder;
...
public class RecentFilesAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private final AdapterCallbacks<File> adapterCallbacks;
    ...
    public RecentFilesAdapter(Context context,boolean showLoader, AdapterCallbacks<File> adapterCallbacks) {
        ...
        listLoader = new ListLoader(true, "No more files");
    }
    ...
    public void addData(File model) {
        list.add(model);
        addLoader();
    }

    public void addAllData(List<File> models) {
        list.addAll(models);
        addLoader();
    }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType == VIEW_TYPE_ITEM) {
            View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.recent_files_layout, parent, false);
            return new RecentFilesViewHolder(view);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        if (holder instanceof RecentFilesViewHolder) {
            ((RecentFilesViewHolder) holder).bind(getItem(position), adapterCallbacks, position);
